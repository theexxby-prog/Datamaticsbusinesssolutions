...
const SEED_NOTIFICATIONS: AppNotification[] = [
  ...
  {
    id: 'notif_seed_overdue',
    campaignId: '46888',
    campaignName: 'Lenovo Intel FIFA AI',
    event: 'invoice_generated',
    description: 'Invoice overdue — payment is past its due date',
    timestamp: new Date(Date.now() - 3 * 60 * 60 * 1000),
    read: false,
    link: '/invoices',
  },
  {
    id: 'notif_seed_pending_leads',
    campaignId: '46888',
    campaignName: 'Lenovo Intel FIFA AI',
    event: '75_percent',
    description: 'Leads awaiting your review — accept or reject to keep delivery moving',
    timestamp: new Date(Date.now() - 4 * 60 * 60 * 1000),
    read: false,
    link: '/leads?status=Pending%20Review&data=all',
  },
  {
    id: 'notif_seed_4',
    campaignId: '46888',
